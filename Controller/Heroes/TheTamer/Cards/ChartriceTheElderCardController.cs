...
{
    public class ChartriceTheElderCardController : LionCardController
    {

        public ChartriceTheElderCardController(Card card, TurnTakerController turnTakerController) : base(card, turnTakerController, TriggerType.DiscardCard)
        {
