...
{
    public class SendToTrashCardController : CardController
    {
		...
		public override IEnumerator Play()
		{
			...
			coroutine = GameController.SelectCardsAndDoAction(scd, (SelectCardDecision card) => GameController.MoveCard(TurnTakerController, card.SelectedCard, selectedTrash, cardSource: GetCardSource()));
			if (base.UseUnityCoroutines)
			{
				yield return base.GameController.StartCoroutine(coroutine);
			}
