...
namespace Studio29.Debugger
{
    public class StackADeckCardController : OptionsCardController
	{
        ...
        public override IEnumerator Play()
        {
			...
			SelectCardsDecision scd = new SelectCardsDecision(GameController, hccc, (Card c) => selectedDeck.HasCard(c) || selectedTrash.HasCard(c) || (selectedDeck.IsHero ? selectedHand.HasCard(c) : false), SelectionType.MoveCardOnDeck, numberOfCards: null, requiredDecisions: 0, eliminateOptions: true, cardSource: GetCardSource());
