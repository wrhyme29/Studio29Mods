...
namespace Studio29.Debugger
{
    public class SendToTrashCardController : OptionsCardController
	{
		...
		public override IEnumerator Play()
        {
            ...
            SelectCardsDecision scd = new SelectCardsDecision(GameController, hccc, (Card c) => selectedDeck.HasCard(c) || (selectedDeck.IsHero ? selectedHand.HasCard(c) : false), SelectionType.MoveCardToTrash, numberOfCards: null, requiredDecisions: 0, eliminateOptions: true, cardSource: GetCardSource());
