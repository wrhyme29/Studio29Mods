...
namespace Studio29.BirthdayBoy
{
    public class AnotherYearOlderCardController : BirthdayBoyCardController
    {
        ...
        public override IEnumerator Play()
        {
            ...
            coroutine = GameController.SendMessageAction(Card.Title + " is removed from the game.", Priority.Medium, GetCardSource(), null, showCardSource: true);
            if (UseUnityCoroutines)
            {
                yield return GameController.StartCoroutine(coroutine);
            }
